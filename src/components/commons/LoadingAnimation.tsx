  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-[#faf2d4]">
      <div className="relative w-64 h-64 sm:w-96 sm:h-96 lg:w-128 lg:h-128">
        ...
        <div className="absolute top-[-50px] left-1/3 transform -translate-x-1/2 w-32 h-32 sm:w-48 sm:h-48 lg:w-64 lg:h-64 animate-smokeRise">
          <Image src="/image/breads/breadSmoke.png" alt="식빵 굽는 연기" layout="fill" objectFit="contain" />
        </div>
        <p className="word-keep-all font-secondary text-xl sm:text-3xl lg:text-4xl mt-2 text-center absolute bottom-[-10px] left-1/2 transform -translate-x-1/2 w-full">
          식빵 굽는 중입니다...
        </p>
      </div>
    </div>
